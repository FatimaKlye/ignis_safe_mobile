...
class PostAssessmentPassPage extends StatefulWidget {
  const PostAssessmentPassPage({super.key});

  @override
  State<PostAssessmentPassPage> createState() => _PostAssessmentPassPageState();
}
...
class _PostAssessmentPassPageState extends State<PostAssessmentPassPage> {
  ...
  String _reviewExplanationFor(int questionIndex) {
    ...
    if (correct != null) {
      return 'The correct answer is "${correct.text}" based on the PASS method.';
    }

    return 'Review the PASS method: Pull, Aim, Squeeze, and Sweep.';
  }
                  ...
                  children: [
                    ...
                    _HintCard(
                      ...
                      text: _isEssay(question)
                          ? 'Write 1 to 2 sentences about what you learned from the PASS method.'
                                  ...
                                  child: Text(
                                    _showReview
                                        ...
                                        : (_assessmentTitle.isEmpty
                                            ? 'Fire Extinguisher PASS Method - Post-Assessment'
                                            : _assessmentTitle),
                                    style: const TextStyle(
                                      color: Colors.black,
