...
class ModuleProgressionService {
  ...
  Future<Map<String, dynamic>?> _repairProgressIfNeeded({
    ...
    // Critical: opening a post-test can create an in-progress attempt.
    ...
    if (hasAnyPostProgress && !progressPostMatchesSubmittedAttempt) {
      payload.addAll({
        'post_test_completed_at': null,
        'post_test_attempt_id': null,
        'post_test_score': null,
        'post_test_correct_count': null,
        'post_test_total_questions': null,
