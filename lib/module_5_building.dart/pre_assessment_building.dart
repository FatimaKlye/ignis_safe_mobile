...
class _PreAssessmentBuildingPageState
  ...
  Widget build(BuildContext context) {
    final headerTitle = _moduleDisplayTitle.trim().isEmpty
        ? 'Tenement / Building Fire: What It Is, Common Causes, and What To Do'
          ...
          Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: const LinearGradient(
                    colors: [kBuildingPurple, kBuildingPurpleDark],
                  ),
                  borderRadius: BorderRadius.circular(12),
                ),
                child: Text(
                  ...
                  child: Row(
                    children: [
                      Icon(
                        ...
                        size: 16,
                        color: isFlagged ? kBuildingPurpleDark : kDarkText,
                      ),
...
class _OptionCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final borderColor =
        selected ? kBuildingPurpleDark : Colors.black.withOpacity(0.08);
    final bgColor = selected ? kBuildingPurple.withOpacity(0.10) : Colors.white;
          ...
          child: Row(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color:
                      selected ? kBuildingPurpleDark : Colors.grey.shade100,
                  shape: BoxShape.circle,
                ),
                child: Center(
                  child: Text(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: kBuildingPurple.withOpacity(0.25)),
      ),
      child: Row(
        children: [
          Icon(icon, color: kBuildingPurpleDark, size: 18),
          const SizedBox(width: 10),
          Expanded(
            child: Text(
              text,
...
class _SummaryCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final statusColor = answered ? const Color(0xFF16A34A) : kBuildingPurpleDark;
            ...
            children: [
              ...
              IconButton(
                ...
                icon: Icon(
                  ...
                  color: flagged ? kBuildingPurpleDark : Colors.grey.shade600,
                ),
              ),
            ],
          ),
...
class _ReviewCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final statusColor =
        isCorrect ? const Color(0xFF16A34A) : kBuildingPurpleDark;
