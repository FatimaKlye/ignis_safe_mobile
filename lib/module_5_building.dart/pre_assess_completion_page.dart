...
import 'module_5_learningmaterials.dart';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      t(
                        context,
                        'Great work! Your result is saved and Module 5 is now ready for you.',
                        'Magaling! Naitala na ang iyong resulta at handa na ang Modyul 5 para sa iyo.',
                      ),
                      textAlign: TextAlign.center,
                      style: const TextStyle(
                        fontFamily: 'Poppins',
                    ...
                    ScoreResultActionButtons(
                      ...
                      onContinue: () => Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
                          builder: (_) => const LearningMaterialTenementPage(),
                        ),
                      ),
                    ),
                  ],
...
class PreAssessmentCompletionPage extends PreAssessmentCompletionPage3 {
