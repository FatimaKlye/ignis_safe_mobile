...
const Color kBuildingPurpleDark = Color(0xFF5B21B6);
const Color kBuildingPurpleSoft = Color(0xFFF5F3FF);
const Color kDarkText = Color(0xFF1F2937);
const Color kSoftBg = Color(0xFFF8FAFC);

class PostAssessmentBuildingPage extends StatefulWidget {
  const PostAssessmentBuildingPage({super.key});

  @override
  State<PostAssessmentBuildingPage> createState() =>
      _PostAssessmentBuildingPageState();
}

class _PostAssessmentBuildingPageState extends State<PostAssessmentBuildingPage> {
  ...
  String _reviewExplanationFor(int questionIndex) {
    ...
    if (correct != null) {
      return _isTl
          ? 'Ang tamang sagot ay "${correct.text}" batay sa simulasyon ng sunog sa tenement.'
          : 'The correct answer is "${correct.text}" based on the tenement fire simulation.';
    }

    return _isTl
        ? 'Suriin ang mga hakbang ng simulasyon ng sunog sa tenement mula sa modyul na ito.'
        : 'Review the tenement fire simulation steps from this module.';
  }
        ...
        actions: [
          ...
          ElevatedButton(
            style: ElevatedButton.styleFrom(
              backgroundColor: kBuildingPurple,
                  ...
                  children: [
                    ...
                    _HintCard(
                      ...
                      text: _isEssay(question)
                          ? (_isTl
                              ? 'Sumulat ng 1 hanggang 2 pangungusap tungkol sa natutunan mo mula sa simulasyon ng sunog sa tenement.'
                              : 'Write 1 to 2 sentences about what you learned from the tenement fire simulation.')
                          : (_isTl
          ...
          children: [
            Expanded(
              child: OutlinedButton(
                style: OutlinedButton.styleFrom(
                  side: const BorderSide(color: kBuildingPurple),
                  shape: RoundedRectangleBorder(
            ...
            Expanded(
              child: ElevatedButton(
                style: ElevatedButton.styleFrom(
                  backgroundColor: kBuildingPurpleDark,
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(18),
                  ),
                  padding: const EdgeInsets.symmetric(vertical: 14),
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: ElevatedButton(
                style: ElevatedButton.styleFrom(
                  backgroundColor: locked ? Colors.grey.shade400 : kBuildingPurple,
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(18),
                  ),
                  padding: const EdgeInsets.symmetric(vertical: 14),
            ...
            children: [
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: isFlagged
                        ? kBuildingPurple.withOpacity(0.12)
                        : Colors.black.withOpacity(0.04),
                    borderRadius: BorderRadius.circular(999),
                    border: Border.all(
                      color: isFlagged ? kBuildingPurple : Colors.black12,
                    ),
                  ),
                  child: Row(
                    children: [
                      Icon(
                        ...
                        size: 16,
                        color: isFlagged ? kBuildingPurple : kDarkText,
                      ),
...
class _OptionCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final borderColor =
        selected ? kBuildingPurple : Colors.black.withOpacity(0.08);
    final bgColor = selected ? kBuildingPurple.withOpacity(0.08) : Colors.white;
          ...
          child: Row(
            ...
            children: [
              Container(
                ...
                height: 34,
                decoration: BoxDecoration(
                  color: selected ? kBuildingPurple : Colors.grey.shade100,
                  shape: BoxShape.circle,
                ),
                child: Center(
                  child: Text(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(18),
        border: Border.all(color: kBuildingPurple.withOpacity(0.18)),
        boxShadow: [
          BoxShadow(
            color: Colors.black.withOpacity(0.05),
            blurRadius: 12,
...
class _HintCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: kBuildingPurpleSoft,
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: kBuildingPurple.withOpacity(0.18)),
      ),
      child: Row(
        children: [
          Icon(icon, color: kBuildingPurple, size: 18),
          const SizedBox(width: 10),
          Expanded(
            child: Text(
              text,
            ...
            children: [
              Container(
                padding:
                    const EdgeInsets.symmetric(horizontal: 10, vertical: 7),
                decoration: BoxDecoration(
                  color: kBuildingPurple.withOpacity(0.10),
                  borderRadius: BorderRadius.circular(999),
                ),
                child: Text(
                  'Q$questionNumber',
              ...
              if (flagged) ...[
                ...
                Container(
                  padding:
                      const EdgeInsets.symmetric(horizontal: 10, vertical: 7),
                  decoration: BoxDecoration(
                    color: kBuildingPurple.withOpacity(0.12),
                    borderRadius: BorderRadius.circular(999),
                  ),
                  child: Text(
              ...
              IconButton(
                ...
                icon: Icon(
                  ...
                  color: flagged ? kBuildingPurple : Colors.grey.shade600,
                ),
              ),
            ],
          ),
...
class _ReviewCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final statusColor = isEssay
        ? kBuildingPurple
        : (isCorrect ? const Color(0xFF16A34A) : kBuildingPurple);
