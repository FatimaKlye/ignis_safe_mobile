...
class PostAssessmentBuildingPage extends StatefulWidget {
  ...
  @override
  State<PostAssessmentBuildingPage> createState() => _PostAssessmentBuildingPageState();
}

class _PostAssessmentBuildingPageState extends State<PostAssessmentBuildingPage>
    with AssessmentLeaveGuard<PostAssessmentBuildingPage> {
  ...
  String _reviewExplanationFor(int questionIndex) {
    ...
    return _txt(
      'Review the building fire lesson from this module.',
      'Suriin muli ang aralin tungkol sa sunog sa gusali ng modyul na ito.',
    );
  }
                    ...
                    children: [
                      ...
                      _HintCard(
                        ...
                        text: _isEssay(question)
                            ? _txt(
                                'Write 1 to 2 sentences about what you learned about safe evacuation during a building fire.',
                                'Sumulat ng 1 hanggang 2 pangungusap tungkol sa iyong natutunan sa ligtas na paglikas kapag may sunog sa gusali.',
                              )
                            : _txt(
