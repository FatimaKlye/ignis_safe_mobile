...
class _SimulationScene5State extends State<SimulationScene5> {
  ...
  static const Color accent2 = Color(0xFF5B21B6);

  static const int _moduleNo = 5;
  static const String _unitySceneName = 'Building_Fire';
  static const String _sceneLabel = 'Module 5 - Scene 5';
  ...
  Widget build(BuildContext context) {
    final title = _isTl ? 'Binubuksan ang Eksena 5' : 'Opening Scene 5';

    final subtitle = _isTl
        ? 'Tutorial sa Paglikas sa Sunog sa Tenement'
        : 'Tenement Fire Evacuation Tutorial';
