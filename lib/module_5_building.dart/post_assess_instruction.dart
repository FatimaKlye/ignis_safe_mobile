...
import 'post_assessment_building.dart';
...
List<String> getConciseInstructions(BuildContext context) {
  return [
    ...
    _getLocalizedText(
      'Your score will show how well you understood Module 5.',
      'Ipapakita ng iyong score kung gaano mo naunawaan ang Modyul 5.',
      context,
    ),
  ];
}

/// Returns the Module 5 topic title with proper localization
String _moduleTitle(BuildContext context) {
  return _getLocalizedText(
    'Building Fire: Alarms, Evacuation, and Emergency Response',
    'Sunog sa Gusali: Alarma, Paglikas, at Pagtugon sa Emerhensiya',
    context,
  );
}
...
class _PostAssessmentIntroPageState extends State<PostAssessmentIntroPage> {
  ...
  Future<void> _startPostAssessment() async {
    ...
    try {
      await ModuleProgressionService().ensureCanStartPostTest(moduleNo: 5);
      if (!mounted) return;
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (_) => const PostAssessmentBuildingPage(),
        ),
      );
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              _getLocalizedText('MODULE 5', 'MODYUL 5', context),
                              softWrap: false,
                              style: const TextStyle(
                                color: AppColors.textOnRed,
                                fontFamily: 'Poppins',
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          isTl
                              ? 'Natapos mo na ang Modyul 5. I-tap ang gabay sa ibaba bago simulan ang panghuling pagsusulit.'
                              : 'You have completed Module 5. Tap a guide below before starting the post-assessment.',
                          softWrap: true,
                          style: TextStyle(
                            color: AppColors.textSecondary,
                            fontFamily: 'Poppins',
    ...
    switch (index) {
      ...
      case 2:
        return _GuideContent(
          ...
          body: isTl
              ? 'Ang panghuling pagsusulit ay susukat kung gaano mo naunawaan ang Modyul 5 pagkatapos mong mag-aral.'
              : 'The post-assessment measures how well you understood Module 5 after studying the lesson.',
          points: isTl
              ? <String>[
      ...
      default:
        return _GuideContent(
          ...
          body: isTl
              ? 'Ito ay maikling pagsusulit matapos basahin ang Modyul 5 sa Pag-aaral.'
              : 'This is a short quiz after reading the Module 5 Learning Materials.',
          points: isTl
              ? <String>[
                  'Susukatin nito ang natutunan mo tungkol sa sunog sa gusali, alarma, ruta ng paglikas, at tamang pagtugon sa emerhensiya.',
                  'Batay ang mga tanong sa Bureau of Fire Protection DASMARIÑAS.',
                ]
              : <String>[
                  'It checks what you learned about building fire basics, alarms, evacuation routes, and proper emergency response.',
