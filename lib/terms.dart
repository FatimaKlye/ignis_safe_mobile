...
class _TermsAndConditionsPageState extends State<TermsAndConditionsPage> {
  ...
  void initState() {
    ...
    _loadExistingConsentStatus();
  }

  Future<void> _loadExistingConsentStatus() async {
    final userId = widget.userId;
    if (widget.readOnly || userId == null) return;

    setState(() => _loadingConsentStatus = true);

    try {
      final active = await _consentService.activeConsentTypes(userId);
      final requiredComplete = ConsentDocuments.required.every(active.contains);
      ...
      // A failed status check must not bypass the normal read-and-accept flow.
      debugPrint('Could not restore existing consent status: $e');
    } finally {
      if (mounted) setState(() => _loadingConsentStatus = false);
    }
  }
  ...
  List<Widget> _buildDocument(BuildContext context) {
    return [
      ...
      _SectionTitle(
        t(
          context,
          '5. Fire-Safety Training Disclaimer',
      ...
      _SectionTitle(
        t(
          context,
          '6. Pre/Post Assessment and Training Records',
      ...
      _SectionTitle(
        t(
          context,
          '7. Optional 3D Simulation Disclaimer',
      ...
      _PartBanner(
        t(
          context,
          'PART II — PRIVACY NOTICE (RA 10173)',
      ...
      _SectionTitle(
        t(
          context,
          '9. Purpose and Lawful Basis of Processing',
      ...
      _SectionTitle(
        t(context, '13. Data Retention', '13. Pag-iingat ng Datos'),
      ),
      _BodyText(
        t(
          context,
      ...
      _SectionTitle(
        t(
          context,
          '14. Data Security and Breach Handling',
      ...
      _SectionTitle(
        t(
          context,
          '17. Research and Statistical Use',
      ...
      _SectionTitle(
        t(context, '18. Intellectual Property', '18. Intelektwal na Ari-arian'),
      ),
      _BodyText(
        t(
          context,
      ...
      _SectionTitle(
        t(
          context,
          '21. Changes to the Terms and Privacy Notice',
      ...
      _PartBanner(
        t(
          context,
          'PART IV — CONTACT AND COMPLAINTS',
      ...
      _SectionTitle(
        t(
          context,
          '23. Privacy and Contact Information',
      ...
      _SectionTitle(
        t(context, 'Purpose of the Research', 'Layunin ng Pananaliksik'),
      ),
      _BodyText(
        t(
          context,
      ...
      _SectionTitle(
        t(context, 'Researchers with Access', 'Mga Mananaliksik na May Access'),
      ),
      _BodyText(
        t(
          context,
      ...
      _SectionTitle(
        t(context, 'Publication and Reporting', 'Paglalathala at Pag-uulat'),
      ),
      _BodyText(
        t(
          context,
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (!_loadingConsentStatus && !_scrolledToBottom)
                    Container(
                      width: double.infinity,
                      padding: const EdgeInsets.symmetric(
                        vertical: 10,
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              t(
                                context,
                                'Terms and Privacy are already completed for the current version.',
                                'Kumpleto na ang pagtanggap sa Tuntunin at Privacy para sa kasalukuyang bersyon.',
                              ),
                              style: const TextStyle(
                                fontFamily: 'Poppins',
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        style: ElevatedButton.styleFrom(
                          ...
                          elevation: (_requiredConsentsGiven && !_saving)
                              ? 2
                              : 0,
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(14),
                        ...
                        onPressed: (_requiredConsentsGiven && !_saving)
                            ? _onAgree
                            : null,
                        child: _saving
                            ? const SizedBox(
