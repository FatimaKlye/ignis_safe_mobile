                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Text(
                                        t(
                                          context,
                                          'Congratulations! You can now proceed to Module 2 Learning Materials.',
                                          'Binabati ka namin! Maaari ka nang magpatuloy sa Modyul 2 sa Pag-aaral.',
                                        ),
                                        textAlign: TextAlign.center,
                                        softWrap: true,
                                        style: const TextStyle(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text(
                                          t(
                                            context,
                                            'Your pre-assessment result has been recorded. Continue to the House Fire learning materials to review the module content before moving to the next activity.',
                                            'Naitala na ang iyong resulta sa paunang pagsusulit. Magpatuloy sa modyul tungkol sa Sunog sa Bahay upang marepaso ang nilalaman bago pumunta sa susunod na gawain.',
                                          ),
                                          softWrap: true,
                                          style: const TextStyle(
                                            fontFamily: 'Poppins',
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    onPressed: () {
                                      Navigator.pushReplacement(
                                        context,
                                        MaterialPageRoute(
                                          builder: (_) => const house_lm
                                              .LearningMaterialHousePage(),
                                        ),
                                      );
                                    },
                                    child: Row(
