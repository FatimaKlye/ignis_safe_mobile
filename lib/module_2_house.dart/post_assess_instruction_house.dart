              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text(
                      isTl ? 'Naiintindihan' : 'I Understand',
                      style: const TextStyle(
                        fontFamily: 'Poppins',
                        fontSize: 15,
                        fontWeight: FontWeight.w900,
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          isTl
                              ? 'Natapos mo na ang Modyul 2. I-tap ang gabay sa ibaba bago simulan ang panghuling pagsusulit.'
                              : 'You have completed Module 2. Tap a guide below before starting the post-assessment.',
                          softWrap: true,
                          style: TextStyle(
                            color: AppColors.textSecondary,
                            fontFamily: 'Poppins',
              ...
              _ModuleTitleBand(
                text: context.tr('module_2_full_title'),
                veryTight: veryTight,
                tight: tight,
              ),
              SizedBox(height: sectionGap),
    ...
    switch (index) {
      ...
      case 2:
        return _GuideContent(
          ...
          body: isTl
              ? 'Ang panghuling pagsusulit ay susukat kung gaano mo naunawaan ang Modyul 2 pagkatapos mong mag-aral.'
              : 'The post-assessment measures how well you understood Module 2 after studying the lesson.',
          points: isTl
              ? <String>[
      ...
      default:
        return _GuideContent(
          ...
          body: isTl
              ? 'Ito ay maikling pagsusulit matapos basahin ang Modyul 2 sa Pag-aaral.'
              : 'This is a short quiz after reading the Module 2 Learning Materials.',
          points: isTl
              ? <String>[
                  'Susukatin nito ang natutunan mo tungkol sa ligtas na paglabas habang may sunog sa bahay.',
                  'Batay ang mga tanong sa Bureau of Fire Protection DASMARIÑAS.',
                ]
              : <String>[
                  'It checks what you learned about getting out safely during a house fire.',
