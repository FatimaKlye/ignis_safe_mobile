...
class PostAssessmentElectricalPage extends StatefulWidget {
  ...
  @override
  State<PostAssessmentElectricalPage> createState() => _PostAssessmentElectricalPageState();
}

class _PostAssessmentElectricalPageState extends State<PostAssessmentElectricalPage> {
  ...
  Future<_CreatedAttempt> _createNewAttempt({
    ...
    // Critical: clear stale rows from previous/regenerated post-test question sets.
    // This prevents old question IDs from controlling the displayed post-test.
    await _supabase
  ...
  String _reviewExplanationFor(int questionIndex) {
    ...
    return _txt(
      'Review the electrical fire safety lesson from this module.',
      'Suriin muli ang aralin tungkol sa ligtas na pagharap sa electrical fire ng modyul na ito.',
    );
  }
                        ...
                        children: [
                          ...
                          _HintCard(
                            ...
                            text: _isEssay(question)
                                ? _txt(
                                    'Write 1 to 2 sentences about what you learned from electrical fire safety.',
                                    'Sumulat ng 1 hanggang 2 pangungusap tungkol sa iyong natutunan sa kaligtasan sa electrical fire.',
                                  )
                                : _txt(
