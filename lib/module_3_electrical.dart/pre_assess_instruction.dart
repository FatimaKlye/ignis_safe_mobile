    ...
    switch (index) {
      case 1:
        return _GuideContent(
          ...
          body: isTl
              ? 'Basahin ang bawat tanong tungkol sa kaligtasan sa kuryente, piliin ang pinakaangkop na sagot, at isumite kapag tapos ka na.'
              : 'Read each electrical safety question, choose the best answer, and submit when you are done.',
          points: isTl
              ? <String>[
      ...
      case 2:
        return _GuideContent(
          ...
          body: isTl
              ? 'Sagutan ito bago basahin ang Module 3 para makita ang tunay mong panimulang kaalaman tungkol sa kaligtasan sa kuryente at sunog.'
              : 'Answer this before reading Module 3 so your real starting knowledge about electrical fire safety can be measured.',
          points: isTl
              ? <String>[
      ...
      default:
        return _GuideContent(
          ...
          body: isTl
              ? 'Ito ay maikling pagsusulit bago ang Module 3. Layunin nitong malaman kung ano na ang alam mo tungkol sa kaligtasan sa kuryente at sunog bago ka magbasa ng aralin.'
              : 'This is a short quiz before Module 3. Its purpose is to check what you already know about electrical fire safety before reading the lesson.',
          points: isTl
              ? <String>[
