...
List<String> getConciseInstructions(BuildContext context) {
  return [
    ...
    _getLocalizedText(
      'Your score will show how well you understood Module 1.',
      'Ipapakita ng iyong score kung gaano mo naunawaan ang Modyul 1.',
      context,
    ),
  ];
}
...
String _getLocalizedPostAssessmentAccessMessage(
  ...
  if (normalized.contains('already') ||
    ...
    return isTl
        ? 'Nasagutan mo na ang Panghuling Pagsusulit. Isang beses lamang ito maaaring kunin.'
        : 'You have already completed the post-assessment. It can only be taken once.';
  }

  return isTl
      ? 'Kumpletuhin muna ang Paunang Pagsusulit at Modyul sa Pag-aaral upang mabuksan ang Panghuling Pagsusulit.'
      : 'Complete the pre-assessment and learning materials to unlock the post-test.';
}

Future<void> _showPostAssessmentAccessDialog(
  BuildContext context,
  String message,
) async {
  if (!context.mounted) return;

  final localizedMessage = _getLocalizedPostAssessmentAccessMessage(
    context,
    message,
  );
...
Future<void> _openPostAssessmentIfAllowed(BuildContext context) async {
  try {
      ...
      bottomNavigationBar: SafeArea(
        ...
        child: _SwipeStartButton(
          label: isTl
              ...
              : 'Start Post-Test',
          onCompleted: () => _openPostAssessmentIfAllowed(context),
        ),
      ),
    );
  }
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          isTl
                              ? 'Natapos mo na ang Modyul 1. I-tap ang gabay sa ibaba bago simulan ang panghuling pagsusulit.'
                              : 'You have completed Module 1. Tap a guide below before starting the post-assessment.',
                          softWrap: true,
                          style: TextStyle(
                            color: AppColors.textSecondary,
                            fontFamily: 'Poppins',
              ...
              _ModuleTitleBand(
                text: context.tr('module_1_full_title'),
                veryTight: veryTight,
                tight: tight,
              ),
              SizedBox(height: sectionGap),
    ...
    switch (index) {
      ...
      case 2:
        return _GuideContent(
          ...
          body: isTl
              ? 'Ang panghuling pagsusulit ay susukat kung gaano mo naunawaan ang Modyul 1 pagkatapos mong mag-aral.'
              : 'The post-assessment measures how well you understood Module 1 after studying the lesson.',
          points: isTl
              ? <String>[
      ...
      default:
        return _GuideContent(
          ...
          body: isTl
              ? 'Ito ay maikling pagsusulit matapos basahin ang Modyul 1 sa Pag-aaral.'
              : 'This is a short quiz after reading the Module 1 Learning Materials.',
          points: isTl
              ? <String>[
                  'Susukatin nito ang natutunan mo tungkol sa batayan, uri, at tamang paggamit ng pamatay-sunog.',
                  'Batay ang mga tanong sa Bureau of Fire Protection DASMARIÑAS.',
                ]
              : <String>[
                  'It checks what you learned about fire extinguisher basics, types, and proper use.',
