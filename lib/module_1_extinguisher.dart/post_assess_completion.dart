                            ...
                            child: Column(
                              children: [
                                ...
                                Text(
                                  t(
                                    context,
                                    'You have completed the Module 1 Post-Assessment.',
                                    'Natapos mo na ang Panghuling Pagsusulit ng Modyul 1.',
                                  ),
                                  textAlign: TextAlign.center,
                                  softWrap: true,
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Text(
                                        t(
                                          context,
                                          'Congratulations! Your score shows how well you understood the Module 1 Learning Materials.',
                                          'Binabati ka namin! Ipinapakita ng iyong score kung gaano mo naunawaan ang Modyul 1 sa Pag-aaral.',
                                        ),
                                        textAlign: TextAlign.center,
                                        softWrap: true,
                                        style: const TextStyle(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text(
                                          t(
                                            context,
                                            'Your post-assessment result has been recorded. This score helps identify what you learned from the fire extinguisher basics, types, and proper use lesson.',
                                            'Naitala na ang iyong resulta sa panghuling pagsusulit. Ang score na ito ay tumutulong matukoy kung ano ang natutunan mo tungkol sa batayan, uri, at tamang paggamit ng pamatay-sunog.',
                                          ),
                                          softWrap: true,
                                          style: const TextStyle(
                                            fontFamily: 'Poppins',
