...
class _PreAssessmentKitchenPageState extends State<PreAssessmentKitchenPage> {
  ...
  String _reviewExplanationFor(int questionIndex) {
    ...
    return 'The correct answer is "${correct.text}" based on the kitchen fire safety guidance in Module 3.';
  }
        ...
        children: [
          ...
          Expanded(
            child: OutlinedButton.icon(
              style: OutlinedButton.styleFrom(
                side: BorderSide(
                  color: isFlagged ? kBrandAmber : Colors.black26,
                ),
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(18),
                ),
              ...
              icon: Icon(
                ...
                color: isFlagged ? kBrandAmber : kDarkText,
              ),
              label: Text(
                            ...
                            ClipRRect(
                              ...
                              child: SizedBox(
                                ...
                                child: LinearProgressIndicator(
                                  ...
                                  valueColor:
                                      const AlwaysStoppedAnimation(kBrandAmber),
                                ),
                              ),
                            ),
                          ],
            ...
            children: [
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: isFlagged
                        ? kBrandAmber.withOpacity(0.12)
                        : Colors.black.withOpacity(0.04),
                    borderRadius: BorderRadius.circular(999),
                    border: Border.all(
                      color: isFlagged ? kBrandAmber : Colors.black12,
                    ),
                  ),
                  child: Row(
                    children: [
...
class _OptionCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bgColor =
        selected ? kBrandAmber.withOpacity(0.10) : Colors.white;
...
class _HintCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: kBrandAmber.withOpacity(0.10),
        borderRadius: BorderRadius.circular(16),
        border: Border.all(
          color: kBrandAmber.withOpacity(0.24),
        ),
      ),
      child: Row(
        children: [
            ...
            children: [
              ...
              if (flagged) ...[
                ...
                Container(
                  padding:
                      const EdgeInsets.symmetric(horizontal: 10, vertical: 7),
                  decoration: BoxDecoration(
                    color: kBrandAmber.withOpacity(0.16),
                    borderRadius: BorderRadius.circular(999),
                  ),
                  child: const Text(
                    'Flagged',
              ...
              IconButton(
                ...
                icon: Icon(
                  ...
                  color: flagged ? kBrandAmber : Colors.grey.shade600,
                ),
              ),
            ],
          ),
...
class _ReviewCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final safeExplanation = explanation?.trim();
