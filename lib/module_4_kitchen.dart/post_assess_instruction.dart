...
String _getLocalizedPostAssessmentAccessMessage(
  ...
  if (normalized.contains('already') ||
    ...
    return isTl
        ...
        : 'You can only take the Post-Assessment once. Continue to the next module.';
  }

  if (normalized.contains('pre-assessment') || normalized.contains('pre-test')) {
    return isTl
...
Future<void> _openPostAssessmentIfAllowed(BuildContext context) async {
  try {
    await ModuleProgressionService().ensureCanStartPostTest(moduleNo: 4);
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          isTl
                              ? 'Natapos mo na ang Modyul 4. I-tap ang gabay sa ibaba bago simulan ang panghuling pagsusulit.'
                              : 'You have completed Module 4. Tap a guide below before starting the post-assessment.',
                          softWrap: true,
                          style: TextStyle(
                            color: AppColors.textSecondary,
                            fontFamily: 'Poppins',
              ...
              _ModuleTitleBand(
                text: context.tr('module_4_full_title'),
                veryTight: veryTight,
                tight: tight,
              ),
              SizedBox(height: sectionGap),
    ...
    switch (index) {
      ...
      case 2:
        return _GuideContent(
          ...
          body: isTl
              ? 'Ang panghuling pagsusulit ay susukat kung gaano mo naunawaan ang Modyul 4 pagkatapos mong mag-aral.'
              : 'The post-assessment measures how well you understood Module 4 after studying the lesson.',
          points: isTl
              ? <String>[
      ...
      default:
        return _GuideContent(
          ...
          body: isTl
              ? 'Ito ay maikling pagsusulit matapos basahin ang Modyul 4 sa Pag-aaral.'
              : 'This is a short quiz after reading the Module 4 Learning Materials.',
          points: isTl
              ? <String>[
                  'Susukatin nito ang natutunan mo tungkol sa batayan ng sunog sa kusina, karaniwang sanhi, pag-iwas, at tamang pagtugon sa emerhensiya.',
                  'Batay ang mga tanong sa Bureau of Fire Protection DASMARIÑAS.',
                ]
              : <String>[
                  'It checks what you learned about kitchen fire basics, common causes, prevention, and proper emergency response.',
