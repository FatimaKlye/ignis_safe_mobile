...
Future<void> _openPreAssessmentIfAllowed(BuildContext context) async {
  try {
    await ModuleProgressionService().ensureCanStartPreTest(moduleNo: 4);
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
        builder: (_) => const PreAssessmentKitchenPage(),
      ),
    );
    ...
    switch (index) {
      case 1:
        return _GuideContent(
          ...
          body: isTl
              ? 'Basahin ang bawat tanong tungkol sa kaligtasan sa kusina, piliin ang pinakaangkop na sagot, at isumite kapag tapos ka na.'
              : 'Read each kitchen fire safety question, choose the best answer, and submit when you are done.',
          points: isTl
              ? <String>[
      ...
      case 2:
        return _GuideContent(
          ...
          body: isTl
              ? 'Sagutan ito bago basahin ang Module 4 para makita ang tunay mong panimulang kaalaman tungkol sa kaligtasan sa kusina at pag-iwas sa sunog.'
              : 'Answer this before reading Module 4 so your real starting knowledge about kitchen fire safety can be measured.',
          points: isTl
              ? <String>[
      ...
      default:
        return _GuideContent(
          ...
          body: isTl
              ? 'Ito ay maikling pagsusulit bago ang Module 4. Layunin nitong malaman kung ano na ang alam mo tungkol sa kaligtasan sa kusina at pag-iwas sa sunog bago ka magbasa ng aralin.'
              : 'This is a short quiz before Module 4. Its purpose is to check what you already know about kitchen fire safety before reading the lesson.',
          points: isTl
              ? <String>[
