...
public class ReturnToFlutter4 : MonoBehaviour
{
    ...
    public void BackToFlutterApp()
    {
        ...
        try
        {
            ...
            if (activity == null)
            {
                Debug.LogError("ReturnToFlutter4: currentActivity is null.");
                _isReturning = false;
                return;
            }

            Debug.Log("ReturnToFlutter4: calling finish() on Unity activity.");
            ...
            activity.Call("runOnUiThread", new AndroidJavaRunnable(() =>
            {
                ...
                {
                    Debug.LogError("ReturnToFlutter4 finish() failed: " + e.Message);
                    _isReturning = false;
                }
                finally
                {
                    ...
                    {
                        Debug.LogError("ReturnToFlutter4: System.exit(0) failed: " + ex.Message);
                    }
                }
            }));
        }
        ...
        {
            Debug.LogError("ReturnToFlutter4 failed: " + e.Message);
            _isReturning = false;
        }
#else
        Debug.Log("ReturnToFlutter4: BackToFlutterApp called. This only returns to Flutter on Android build.");
#endif
    }
    ...
    {
        IsReturning = false;
        Debug.Log("[ReturnToFlutter4] IsReturning reset (editor/testing only).");
    }
}
