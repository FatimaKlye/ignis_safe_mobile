...
public class ReturnToFlutter3 : MonoBehaviour
{
    ...
    public void BackToFlutterApp()
    {
        ...
        try
        {
            ...
            if (activity == null)
            {
                Debug.LogError("ReturnToFlutter3: currentActivity is null.");
                _isReturning = false;
                return;
            }

            Debug.Log("ReturnToFlutter3: calling finish() on Unity activity.");
            ...
            activity.Call("runOnUiThread", new AndroidJavaRunnable(() =>
            {
                ...
                {
                    Debug.LogError("ReturnToFlutter3 finish() failed: " + e.Message);
                    _isReturning = false;
                }
                finally
                {
                    ...
                    {
                        Debug.LogError("ReturnToFlutter3: System.exit(0) failed: " + ex.Message);
                    }
                }
            }));
        }
        ...
        {
            Debug.LogError("ReturnToFlutter3 failed: " + e.Message);
            _isReturning = false;
        }
#else
        Debug.Log("ReturnToFlutter3: BackToFlutterApp called. This only returns to Flutter on Android build.");
#endif
    }
    ...
    {
        IsReturning = false;
        Debug.Log("[ReturnToFlutter3] IsReturning reset (editor/testing only).");
    }
}
